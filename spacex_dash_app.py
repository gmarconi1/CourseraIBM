...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names=list(spacex_df['Launch Site'].values), 
        title='Total success launches')
        return fig
    else:
        filtered_df = spacex_df
        filtered_df.rename(columns={'Launch Site':'LaunchSite'},inplace=True)
        filtered_df = filtered_df[spacex_df.LaunchSite==entered_site]
...
def get_scatter_chart(entered_site,payload):
    if entered_site == 'ALL':
            ...
            title='Corralation between Payload and Succes for all sites')
            return fig
    else:
        low, high = payload
        filtered_df = spacex_df
        ...
        title='Corralation between Payload and Succes for {}'.format(entered_site))
        return fig
# Run the app
